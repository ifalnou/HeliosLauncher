    ...
    authKeys.forEach((val) => {
        ...
        const accHtml = `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="${acc.accessToken === "MyAccessTokn" ? `http://ns3014075.ip-149-202-65.eu:1564/skin/${acc.uuid}/head` : `https://mc-heads.net/body/${acc.uuid}/60`}">
            </div>
